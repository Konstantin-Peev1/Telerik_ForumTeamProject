...
namespace Telerik_ForumTeamProject.Migrations
{
    ...
    [Migration("20240719201312_Initial")]
            ...
            modelBuilder.Entity("Telerik_ForumTeamProject.Models.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 19, 23, 13, 12, 91, DateTimeKind.Local).AddTicks(5207),
                            PostID = 1,
                            UserID = 1
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 19, 23, 13, 12, 91, DateTimeKind.Local).AddTicks(5401),
                            ParentCommentID = 1,
                            PostID = 1,
                            UserID = 1
                        });
            ...
            modelBuilder.Entity("Telerik_ForumTeamProject.Models.Entities.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 19, 23, 13, 12, 91, DateTimeKind.Local).AddTicks(5170),
            ...
            modelBuilder.Entity("Telerik_ForumTeamProject.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsBlocked = false,
                            LastName = "Peev",
                            Password = "$2b$10$t2pCoSzrCppt7sShiHlJ/e.D1Prmtk1wjRRwY0kHS.r5ldxUaiaoy",
                            Role = "Admin",
                            UserName = "Kosio_Peev"
                        });
                });
