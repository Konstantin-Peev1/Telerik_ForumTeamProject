    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "User", "konstantin.i.peev@gmail.com", "Konstantin", true, false, "Peev", "$2b$10$hvRYo8wjRT9771k9z7vZjedhs3hJ51YxQzuVcanco2Kc.2DQ20/nO", "Kosio_Peev" });

            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "Id", "Content", "Created", "Title", "UserID" },
                values: new object[] { 1, "Wow this is the first post I have written", new DateTime(2024, 7, 8, 19, 24, 59, 929, DateTimeKind.Local).AddTicks(5095), "This is my first post!!", 1 });
