...
namespace Telerik_ForumTeamProject.Migrations
{
    ...
    [Migration("20240708162500_initial")]
            ...
            modelBuilder.Entity("Telerik_ForumTeamProject.Models.Entities.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 8, 19, 24, 59, 929, DateTimeKind.Local).AddTicks(5095),
            ...
            modelBuilder.Entity("Telerik_ForumTeamProject.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsBlocked = false,
                            LastName = "Peev",
                            Password = "$2b$10$hvRYo8wjRT9771k9z7vZjedhs3hJ51YxQzuVcanco2Kc.2DQ20/nO",
                            UserName = "Kosio_Peev"
                        });
                });
