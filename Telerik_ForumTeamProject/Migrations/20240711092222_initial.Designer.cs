...
namespace Telerik_ForumTeamProject.Migrations
{
    ...
    [Migration("20240711092222_initial")]
            ...
            modelBuilder.Entity("Telerik_ForumTeamProject.Models.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 11, 12, 22, 21, 859, DateTimeKind.Local).AddTicks(6528),
                            PostID = 1,
                            UserID = 1
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 11, 12, 22, 21, 859, DateTimeKind.Local).AddTicks(6532),
                            ParentCommentID = 1,
                            PostID = 1,
                            UserID = 1
                        });
            ...
            modelBuilder.Entity("Telerik_ForumTeamProject.Models.Entities.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 11, 12, 22, 21, 859, DateTimeKind.Local).AddTicks(6492),
            ...
            modelBuilder.Entity("Telerik_ForumTeamProject.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsBlocked = false,
                            LastName = "Peev",
                            Password = "$2b$10$x7ChjBdRoEZz/xtmLkIsE.nBSmWSDqwX1qZ56AuT3PYSax62NkmNS",
                            Role = "Admin",
                            UserName = "Kosio_Peev"
                        });
                });
