...
namespace Telerik_ForumTeamProject.Migrations
{
    ...
    [Migration("20240710125333_initial")]
            ...
            modelBuilder.Entity("Telerik_ForumTeamProject.Models.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 10, 15, 53, 33, 608, DateTimeKind.Local).AddTicks(6475),
                            PostID = 1,
                            UserID = 1
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 10, 15, 53, 33, 608, DateTimeKind.Local).AddTicks(6480),
                            ParentCommentID = 1,
                            PostID = 1,
                            UserID = 1
                        });
            ...
            modelBuilder.Entity("Telerik_ForumTeamProject.Models.Entities.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 7, 10, 15, 53, 33, 608, DateTimeKind.Local).AddTicks(6438),
            ...
            modelBuilder.Entity("Telerik_ForumTeamProject.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsBlocked = false,
                            LastName = "Peev",
                            Password = "$2b$10$1cmXKaXvjUkRWlRFO6aKTurtBSFtuSQzw4xbVnoPq1vwXOHwWfLcC",
                            Role = "Admin",
                            UserName = "Kosio_Peev"
                        });
                });
